...
namespace Qualıty_Checker
{
    public class ColorHandler
    {
        ...
        public static Color HSVtoColor(HSV hsv)
        {
            ...
            //return Color.FromArgb(Math.Abs(argb.Alpha), Math.Abs(argb.Red), Math.Abs(argb.Green), Math.Abs(argb.Blue)); // (double)argb.Red + (double)argb.Green + (double)argb.Blue / 3
            return Color.FromArgb(Math.Abs(argb.Alpha), (argb.Red + argb.Green + argb.Blue) / 3, (argb.Red + argb.Green + argb.Blue) / 3, (argb.Red + argb.Green + argb.Blue) / 3);
        }
        ...
        public static HSV RGBtoHSV(ARGB argb)
        {
            ...
            */
            double r = ((double)argb.Red + (double)argb.Green + (double)argb.Blue) / 3;
            double g = ((double)argb.Red + (double)argb.Green + (double)argb.Blue) / 3;
            double b = ((double)argb.Red + (double)argb.Green + (double)argb.Blue) / 3;
